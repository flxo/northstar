...
use super::{
    clone::clone, fs::Mount, io::Fd, seccomp::AllowList, Checkpoint, Container, PipeRead,
    SIGNAL_OFFSET,
};
use nix::{
    errno::Errno,
...
fn set_ids(uid: u32, gid: u32) {
    ...
    if rt_privileged {
        // Resetting effective caps to the most possible set TODO: this includes an allocation
